...
require "test/unit"
require_relative "../lib/bit_field"

class TestBitField < Test::Unit::TestCase
  def setup
    @public_bf = DataStructure::BitField.new(1000)
  end

  def test_basic
    assert_equal 0, DataStructure::BitField.new(100)[0]
    assert_equal 0, DataStructure::BitField.new(100)[1]
  end
  ...
  def test_to_s
    bf = DataStructure::BitField.new(10)
    bf[1] = 1
    bf[5] = 1
